...
def initialize_parameters(years=[]):
    ...
    for year in years:
        ...
        data_ttes[year] = {'p_ttes_losses': p_ttes_losses, 'p_ttes_eta': p_ttes_eta, 'p_ttes_init': p_ttes_init, 'p_ttes_end': p_ttes_end, 'p_ttes_c_inv': p_ttes_c_inv, 'p_ttes_elec': p_ttes_elec, 'p_ttes_cop': p_ttes_cop, 'p_ttes_c_charge_discharge': p_ttes_c_charge_discharge, 'p_ttes_inv': p_ttes_inv}
        ...
        data_btes[year] = {'p_btes_losses': p_btes_losses, 'p_btes_eta': p_btes_eta, 'p_btes_init': p_btes_init, 'p_btes_end': p_btes_end, 'p_btes_c_inv': p_btes_c_inv, 'p_btes_elec': p_btes_elec, 'p_btes_cop': p_btes_cop, 'p_btes_c_charge_discharge': p_btes_c_charge_discharge, 'p_btes_inv': p_btes_inv}
        ...
        data_ites[year] = {'p_ites_losses': p_ites_losses, 'p_ites_eta': p_ites_eta, 'p_ites_init': p_ites_init, 'p_ites_end': p_ites_end, 'p_ites_c_inv': p_ites_c_inv, 'p_ites_elec': p_ites_elec, 'p_ites_seer': p_ites_seer, 'p_ites_c_charge_discharge': p_ites_c_charge_discharge, 'p_ites_inv': p_ites_inv}
