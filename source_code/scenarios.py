def define_scenarios(scenarios_weighting, year_expansion_range, heating_demand, cooling_demand, electricity_price, electricity_mean_price, electricity_co2_share, electricity_mean_co2_share, gas_price, co2_price, data_eb, data_hp, data_st, data_wi, data_gt, data_dgt, data_ieh, data_chp, data_ac, data_ab, data_cp, data_ttes, data_ites):
    ...
    data['1_reference'] = {'scenario_weighting': scenarios_weighting['1_reference'],
    ...
    data['2_high_electricity_prices'] = {'scenario_weighting': scenarios_weighting['2_high_electricity_prices'],
                                         'year_expansion_range': year_expansion_range,
                                         'heating': heating_demand,
                                         'cooling': cooling_demand,
    ...
    # data['3_low_electricity_prices'] = {'scenario_weighting': scenarios_weighting['3_low_electricity_prices'],
    #                                     'year_expansion_range': year_expansion_range,
    #                                     'heating': heating_demand,
    #                                     'cooling': cooling_demand,
    ...
    # data['4_flexible_energy_market'] = {'scenario_weighting': scenarios_weighting['4_flexible_energy_market'],
    #                                     'year_expansion_range': year_expansion_range,
    #                                     'heating': heating_demand,
    #                                     'cooling': cooling_demand,
    ...
    # data['5_energy_congestion'] = {'scenario_weighting': scenarios_weighting['5_energy_congestion'],
    #                                'year_expansion_range': year_expansion_range,
    #                                'heating': heating_demand,
    #                                'cooling': cooling_demand,
    ...
    # data['6_green_friendly'] = {'scenario_weighting': scenarios_weighting['6_green_friendly'],
    #                             'year_expansion_range': year_expansion_range,
    #                             'heating': heating_demand,
    #                             'cooling': cooling_demand,
    #                             'electricity_price': electricity_price,
    ...
    #                             'gt': {year: {name: (value * 0.8 if name == 'p_gt_c_inv' else value) for name, value in dict_items.items()} for year, dict_items in data_gt.items()},
    #                             'dgt': {year: {name: (value * 0.8 if name == 'p_dgt_c_inv' else value) for name, value in dict_items.items()} for year, dict_items in data_dgt.items()},
    ...
    # data['7_low_gas_demand'] = {'scenario_weighting': scenarios_weighting['7_low_gas_demand'],
    #                             'year_expansion_range': year_expansion_range,
    #                             'heating': heating_demand,
    #                             'cooling': cooling_demand,
    ...
    # data['8_natural_gas_friendly'] = {'scenario_weighting': scenarios_weighting['8_natural_gas_friendly'],
    #                                   'year_expansion_range': year_expansion_range,
    #                                   'heating': heating_demand,
    #                                   'cooling': cooling_demand,
    #                                   'electricity_price': electricity_price,
    ...
    # data['9_warm_winters'] = {'scenario_weighting': scenarios_weighting['9_warm_winters'],
    #                           'year_expansion_range': year_expansion_range,
    #                           'heating': {year: [value * 0.75 for value in values] if year in [2045, 2050] else values for year, values in heating_demand.items()},
    #                           'cooling': cooling_demand,
    #                           'electricity_price': electricity_price,
    #                           'electricity_mean_price': electricity_mean_price,
    #                           'electricity_co2_share': electricity_co2_share,
    ...
    # data['10_cold_winters'] = {'scenario_weighting': scenarios_weighting['10_cold_winters'],
    #                            'year_expansion_range': year_expansion_range,
    ...
    # data['11_hot_summers'] = {'scenario_weighting': scenarios_weighting['11_hot_summers'],
    #                           'year_expansion_range': year_expansion_range,
    #                           'heating': heating_demand,
    ...
    # data['12_warm_summers'] = {'scenario_weighting': scenarios_weighting['12_warm_summers'],
    #                            'year_expansion_range': year_expansion_range,
    #                            'heating': heating_demand,
    ...
    # data['13_moderate_climate'] = {'scenario_weighting': scenarios_weighting['13_moderate_climate'],
    #                                'year_expansion_range': year_expansion_range,
    ...
    # data['14_zero_co2_price'] = {'scenario_weighting': scenarios_weighting['14_zero_co2_price'],
    #                              'year_expansion_range': year_expansion_range,
    #                              'heating': heating_demand,
    #                              'cooling': cooling_demand,
    #                              'electricity_price': {year: [value * 0.8 for value in values] for year, values in electricity_price.items()},
    ...
    # data['15_delayed_co2_pricing'] = {'scenario_weighting': scenarios_weighting['15_delayed_co2_pricing'],
    #                                   'year_expansion_range': year_expansion_range,
    #                                   'heating': heating_demand,
    #                                   'cooling': cooling_demand,
    #                                   'electricity_price': electricity_price,
    ...
    # data['16_ambitious_co2_pricing'] = {'scenario_weighting': scenarios_weighting['16_ambitious_co2_pricing'],
    #                                     'year_expansion_range': year_expansion_range,
    #                                     'heating': heating_demand,
    #                                     'cooling': cooling_demand,
    #                                     'electricity_price': electricity_price,
    ...
    # data['17_expiring_support_res'] = {'scenario_weighting': scenarios_weighting['17_expiring_support_res'],
    #                                    'year_expansion_range': year_expansion_range,
    #                                    'heating': heating_demand,
    #                                    'cooling': cooling_demand,
    #                                    'electricity_price': electricity_price,
    ...
    #                                    'gt': {year: {name: (value * 0.7 if name == 'p_gt_c_inv' and year in [2025, 2030] else value) for name, value in dict_items.items()} for year, dict_items in data_gt.items()},
    #                                    'dgt': {year: {name: (value * 0.7 if name == 'p_dgt_c_inv' and year in [2025, 2030] else value) for name, value in dict_items.items()} for year, dict_items in data_dgt.items()},
    ...
    # data['18_res_friendly'] = {'scenario_weighting': scenarios_weighting['18_res_friendly'],
    #                            'year_expansion_range': year_expansion_range,
    #                            'heating': heating_demand,
    #                            'cooling': cooling_demand,
    #                            'electricity_price': electricity_price,
    ...
    #                            'gas_price': gas_price,
    #                            'co2_price': co2_price,
    #                            'eb': {year: {name: (value * 0.7 if name == 'p_eb_c_inv' else value) for name, value in dict_items.items()} for year, dict_items in data_eb.items()},
    #                            'hp': {year: {name: (value * 0.7 if name == 'p_hp_c_inv' else value) for name, value in dict_items.items()} for year, dict_items in data_hp.items()},
    #                            'st': {year: {name: (value * 0.7 if name == 'p_st_c_inv' else value) for name, value in dict_items.items()} for year, dict_items in data_st.items()},
    #                            'wi': {year: {name: (value * 0.7 if name == 'p_wi_c_inv' else value) for name, value in dict_items.items()} for year, dict_items in data_wi.items()},
    #                            'gt': {year: {name: (value * 0.7 if name == 'p_gt_c_inv' else value) for name, value in dict_items.items()} for year, dict_items in data_gt.items()},
    #                            'dgt': {year: {name: (value * 0.7 if name == 'p_dgt_c_inv' else value) for name, value in dict_items.items()} for year, dict_items in data_dgt.items()},
    #                            'ieh': {year: {name: (value * 0.7 if name == 'p_ieh_c_inv' else value) for name, value in dict_items.items()} for year, dict_items in data_ieh.items()},
    #                            'chp': {year: {name: (value * 0.7 if name == 'p_chp_c_inv' else value) for name, value in dict_items.items()} for year, dict_items in data_chp.items()},
    #                            'ac': {year: {name: (value * 0.7 if name == 'p_ac_c_inv' else value) for name, value in dict_items.items()} for year, dict_items in data_ac.items()},
