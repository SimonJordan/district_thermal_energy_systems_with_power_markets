...
def add_hp_equations(m=None):
    ...
    def hp_feed_in_max_bound(m, s, y, t):
        return m.v_hp_q_heat_in[s, y, t] <= m.v_hp_Q_heat_max[s, y]
    
    # def hp_limit(m, s, y):
    #     return m.v_hp_Q_heat_max[s, y] <= 300
    ...
    def hp_c_var(m, s, y, t): # OPAM = operational and maintanance, förderung?
        return m.v_hp_c_var[s, y, t] == m.v_hp_q_elec_consumption[s, y, t] * m.p_c_elec[s, y, t]
