...
def export_result(m=None, data={}, scenarios=[], years=[], hours=[]):
    ...
    for scenario in scenarios:
        ...
        for year in years:
            ...
            gb_inv.append(py.value(m.v_gb_Q_inv[scenario, year]))
            ...
            ttes_hp_inv.append(py.value(m.v_ttes_hp_Q_inv[scenario, year]))
            btes_inv.append(py.value(m.v_btes_k_inv[scenario, year]))
            btes_hp_inv.append(py.value(m.v_btes_hp_Q_inv[scenario, year]))
            ites_inv.append(py.value(m.v_ites_k_inv[scenario, year]))
            ites_ac_inv.append(py.value(m.v_ites_ac_Q_inv[scenario, year]))
            ...
            btes_c_inv.append(py.value(m.v_btes_c_inv[scenario, year]))
            ites_c_inv.append(py.value(m.v_ites_c_inv[scenario, year]))
            
            eb_c_fix.append(py.value(m.v_eb_c_fix[scenario, year]))
            gb_c_fix.append(py.value(m.v_gb_c_fix[scenario, year]))
            ...
            btes_c_fix.append(py.value(m.v_btes_c_fix[scenario, year]))
            ites_c_fix.append(py.value(m.v_ites_c_fix[scenario, year]))
            
            for hour in hours:
                eb_heat_in.append(py.value(m.v_eb_q_heat_in[scenario, year, hour]))
                gb_heat_in.append(py.value(m.v_gb_q_heat_in[scenario, year, hour]))
                ...
                wi_heat_out.append(py.value(m.v_wi_q_heat_out[scenario, year, hour]))
                ...
                gb_c_var.append(py.value(m.v_gb_c_var[scenario, year, hour]))
                ...
                btes_c_var.append(py.value(m.v_btes_c_var[scenario, year, hour]))
                ...
                btes_elec.append(py.value(m.v_btes_q_elec_consumption[scenario, year, hour]))
            ...
            df_5.append(pd.DataFrame({'hour': hours, 'eb': eb_c_var, 'gb': gb_c_var, 'hp': hp_c_var, 'st': st_c_var, 'wi': wi_c_var, 'ieh': ieh_c_var, 'chp': chp_c_var, 'ac': ac_c_var, 'ab_ct': ab_ct_c_var, 'ab_hp': ab_hp_c_var, 'cp_ct': cp_ct_c_var, 'cp_hp': cp_hp_c_var, 'ttes': ttes_c_var, 'btes': btes_c_var, 'ites': ites_c_var}))
            df_6.append(pd.DataFrame({'hour': hours, 'eb': eb_elec, 'hp': hp_elec, 'st': st_elec, 'ieh': ieh_elec, 'ac': ac_elec, 'ab_ct': ab_ct_elec, 'ab_hp': ab_hp_elec, 'cp_ct': cp_ct_elec, 'cp_hp': cp_hp_elec, 'ttes': ttes_elec, 'btes': btes_elec, 'ites': ites_elec}))
            ...
            df_9.append(pd.DataFrame({'hour': hours, 'ttes': ttes_soc, 'btes': btes_soc, 'ites': ites_soc}))
