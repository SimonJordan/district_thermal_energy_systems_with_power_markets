    ...
    for scenario in scenarios:
        ...
        for year in years:
            ...
            for hour in hours:
                ...
                gt_heat_in.append(py.value(m.v_gt_q_heat_in[scenario, year, hour]))
                dgt_heat_in.append(py.value(m.v_dgt_q_heat_in[scenario, year, hour]))
                ...
                dgt_elec.append(py.value(m.v_dgt_q_elec_consumption[scenario, year, hour]))
            ...
            df_3.append(pd.DataFrame({'eb': eb_c_inv, 'hp': hp_c_inv, 'st': st_c_inv, 'wi': wi_c_inv, 'gt': gt_c_inv, 'dgt': dgt_c_inv, 'ieh': ieh_c_inv, 'chp': chp_c_inv, 'ac': ac_c_inv, 'ab_ct': ab_ct_c_inv, 'ab_hp': ab_hp_c_inv, 'cp_ct': cp_ct_c_inv, 'cp_hp': cp_hp_c_inv, 'ttes': ttes_c_inv, 'ites': ites_c_inv}))
            ...
            df_5.append(pd.DataFrame({'hour': hours, 'eb': eb_c_var, 'hp': hp_c_var, 'st': st_c_var, 'wi': wi_c_var, 'gt': gt_c_var, 'dgt': dgt_c_var, 'ieh': ieh_c_var, 'chp': chp_c_var, 'ac': ac_c_var, 'ab_ct': ab_ct_c_var, 'ab_hp': ab_hp_c_var, 'cp_ct': cp_ct_c_var, 'cp_hp': cp_hp_c_var, 'ttes': ttes_c_var, 'ites': ites_c_var}))
            df_6.append(pd.DataFrame({'hour': hours, 'eb': eb_elec, 'hp': hp_elec, 'st': st_elec, 'gt': gt_elec, 'dgt': dgt_elec, 'ieh': ieh_elec, 'ac': ac_elec, 'ab_ct': ab_ct_elec, 'ab_hp': ab_hp_elec, 'cp_ct': cp_ct_elec, 'cp_hp': cp_hp_elec, 'ttes': ttes_elec, 'ites': ites_elec}))
