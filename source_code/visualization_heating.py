...
fig.add_trace(go.Bar(x=years[:5], y=list(storages_map['Tank thermal energy storage'][visualize_scenario].values())[:5], name='Tank thermal energy storage', marker=dict(color='grey')), row=1, col=2)
