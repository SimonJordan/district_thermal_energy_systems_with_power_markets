...
path_to_file_pjm = os.path.join(path_to_data_folder, 'pjm_real_time_prices.csv')
path_to_file_pjm_bge = os.path.join(path_to_data_folder, 'pjm_real_time_prices_bge.csv')
