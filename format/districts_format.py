...
path_to_text_files = os.path.join(path_to_data_folder, 'districts', 'sum')
# path_to_output_file_heating = os.path.join(path_to_data_folder, 'districts_heating_demand.xlsx')
# path_to_output_file_cooling = os.path.join(path_to_data_folder, 'districts_cooling_demand.xlsx')
# file_names = [f'Building_{i}.txt' for i in range(1, 40)]
# path_to_output_file_heating = os.path.join(path_to_data_folder, 'districts_heating_demand_phase0.xlsx')
# path_to_output_file_cooling = os.path.join(path_to_data_folder, 'districts_cooling_demand_phase0.xlsx')
# file_names = [f'Building_{i}.txt' for i in [1, 2, 3, 4, 5, 6, 8, 9, 12, 14, 19, 23, 26, 27, 32, 33, 36, 38]]
# path_to_output_file_heating = os.path.join(path_to_data_folder, 'districts_heating_demand_phase1.xlsx')
# path_to_output_file_cooling = os.path.join(path_to_data_folder, 'districts_cooling_demand_phase1.xlsx')
...
path_to_output_file_heating = os.path.join(path_to_data_folder, 'districts_heating_demand_phase2.xlsx')
path_to_output_file_cooling = os.path.join(path_to_data_folder, 'districts_cooling_demand_phase2.xlsx')
file_names = [f'Building_{i}.txt' for i in range(1, 40)]
