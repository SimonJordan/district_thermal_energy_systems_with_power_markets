...
columns_1 = [f'TotalCoolingSensibleLoad (W) Building {i}' for i in range(1, 36)]
columns_2 = [f'TotalHeatingSensibleLoad (W) Building {i}' for i in range(1, 36)]
columns_3 = [f'TotalWaterHeating (W) Building {i}' for i in range(1, 36)]
